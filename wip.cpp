...
//checks indivudal integer values if they are out of bounds of the map, for ai attacking
...
//is the main function for checking if a user inputted too many boats.
